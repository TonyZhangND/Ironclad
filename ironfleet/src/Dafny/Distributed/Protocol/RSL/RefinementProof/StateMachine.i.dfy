...
ghost predicate RslSystemInit(s:RSLSystemState, server_addresses:set<NodeIdentity>)
{
...
ghost predicate RslSystemNextServerExecutesRequest(s:RSLSystemState, s':RSLSystemState, req:Request)
{
...
ghost predicate RslStateSequenceReflectsBatchExecution(s:RSLSystemState, s':RSLSystemState, intermediate_states:seq<RSLSystemState>,
                                                 batch:seq<Request>)
{
...
ghost predicate RslSystemNext(s:RSLSystemState, s':RSLSystemState)
{
  exists intermediate_states, batch :: RslStateSequenceReflectsBatchExecution(s, s', intermediate_states, batch)
}

ghost predicate RslSystemRefinement(ps:RslState, rs:RSLSystemState)
{
...
ghost predicate RslSystemBehaviorRefinementCorrect(server_addresses:set<NodeIdentity>, low_level_behavior:seq<RslState>, high_level_behavior:seq<RSLSystemState>)
{
