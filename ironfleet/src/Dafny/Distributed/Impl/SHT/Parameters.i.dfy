...
ghost function AbstractifyCParametersToParameters(params:CParameters) : Parameters
{
    Parameters(params.max_seqno as int, params.max_delegations as int)
}

ghost predicate CParametersIsValid(params:CParameters)
{
       params.max_seqno == 0xFFFF_FFFF_FFFF_FFFF
    && 3 < params.max_delegations < 0x8000_0000_0000_0000
}

function StaticParams() : CParameters
{
