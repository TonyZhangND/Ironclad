...
ghost predicate AllIosAreSends(ios:seq<RslIo>)
{
...
ghost predicate {:opaque} Q_LReplica_Next_Process_Invalid(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_Invalid? && LReplicaNextProcessInvalid(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_Request(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_Request? && LReplicaNextProcessRequest(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_1a(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_1a? && LReplicaNextProcess1a(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_1b(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_1b? && LReplicaNextProcess1b(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_StartingPhase2(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_StartingPhase2? && LReplicaNextProcessStartingPhase2(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_2a(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_2a? && LReplicaNextProcess2a(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_2b(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
...
ghost predicate {:opaque} Q_LReplica_Next_Process_Reply(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_Reply? && LReplicaNextProcessReply(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_AppStateRequest(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_AppStateRequest? && LReplicaNextProcessAppStateRequest(replica, replica', lpacket, sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Process_AppStateSupply(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>)
{ lpacket.msg.RslMessage_AppStateSupply? && LReplicaNextProcessAppStateSupply(replica, replica', lpacket, sent_packets) }



ghost predicate LReplica_Next_ProcessPacketWithoutReadingClock_preconditions(ios:seq<RslIo>)
{
  && |ios| >= 1
  && ios[0].LIoOpReceive?
...
ghost predicate {:opaque} Q_LReplica_Next_ProcessPacketWithoutReadingClock(replica:LReplica, replica':LReplica, ios:seq<RslIo>)
{
...
ghost predicate Establish_Q_LReplica_Next_ProcessPacketWithoutReadingClock_preconditions(replica:LReplica, replica':LReplica, lpacket:RslPacket, sent_packets:seq<RslPacket>, ios:seq<RslIo>)
{
...
ghost predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeEnterNewViewAndSend1a(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
{ LReplicaNextSpontaneousMaybeEnterNewViewAndSend1a(replica, replica', sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeEnterPhase2(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
{ LReplicaNextSpontaneousMaybeEnterPhase2(replica, replica', sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Spontaneous_TruncateLogBasedOnCheckpoints(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
{ LReplicaNextSpontaneousTruncateLogBasedOnCheckpoints(replica, replica', sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeMakeDecision(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
{ LReplicaNextSpontaneousMaybeMakeDecision(replica, replica', sent_packets) }

ghost predicate {:opaque} Q_LReplica_Next_Spontaneous_MaybeExecute(replica:LReplica, replica':LReplica, sent_packets:seq<RslPacket>)
...
ghost predicate {:opaque} Q_LReplica_Next_ReadClock_MaybeNominateValueAndSend2a(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>)
{ LReplicaNextReadClockMaybeNominateValueAndSend2a(replica, replica', clock, sent_packets) }


ghost predicate {:opaque} Q_LReplica_Next_ReadClock_CheckForViewTimeout(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>)
{
  LReplicaNextReadClockCheckForViewTimeout(replica, replica', clock, sent_packets)
}

ghost predicate {:opaque} Q_LReplica_Next_ReadClock_CheckForQuorumOfViewSuspicions(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>)
{
  LReplicaNextReadClockCheckForQuorumOfViewSuspicions(replica, replica', clock, sent_packets)
}

ghost predicate {:opaque} Q_LReplica_Next_ReadClock_MaybeSendHeartbeat(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>)
{
  LReplicaNextReadClockMaybeSendHeartbeat(replica, replica', clock, sent_packets)
}

ghost predicate {:opaque} Q_LReplica_NoReceive_Next(replica:LReplica, nextActionIndex:int, replica':LReplica, ios:seq<RslIo>)
{
  LReplicaNoReceiveNext(replica, nextActionIndex, replica', ios)
}

ghost predicate {:opaque} Q_LReplica_Next_ProcessPacket(replica:LReplica, replica':LReplica, ios:seq<RslIo>)
{
...
ghost predicate {:opaque} Q_LScheduler_Next(s:LScheduler, s':LScheduler, ios:seq<RslIo>)
{
  LSchedulerNext(s, s', ios)
}

ghost predicate Establish_Q_LReplica_NoReceive_Next_preconditions(replica:LReplica, replica':LReplica, clock:ClockReading, sent_packets:seq<RslPacket>, nextActionIndex:int, ios:seq<RslIo>)
{
