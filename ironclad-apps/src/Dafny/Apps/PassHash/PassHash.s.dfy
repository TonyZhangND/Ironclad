...
static ghost predicate {:autoReq} PassHashInitializeValid(passhash_state:PassHashState, before_TPM:TPM_struct, after_TPM:TPM_struct)
{
...
static ghost predicate {:autoReq} PassHashPerformHashValid(passhash_state:PassHashState, message_in:seq<int>, salt_in:seq<int>,
